package EjerciciosNormales.Ejercicio1;

public class SaludoPrincipal {

/*En alemania los alumnos muestran absoluto silencio y respeto hasta que 
 * el profesor saluda a la clase "Guten Morgen die Klasse!".A continuaci�n
 * los alumnos saludar�n al profesor diciendo sus respectivos nombres
